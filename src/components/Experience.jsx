    ...
    <>
      <style>{`
        ...
        .timeline-badge {
          ...
          padding: .2rem .6rem;
          border: 1px solid var(--item-color, var(--accent));
        ...
        .timeline-company {
          font-size: 1rem; color: var(--item-color, var(--accent));
          font-weight: 600; margin-bottom: .8rem;
        }
        .timeline-desc {
          font-family: var(--font-mono); font-size: .82rem;
          color: var(--text2); line-height: 1.75; max-width: 600px;
          font-weight: 300;
        }
      `}</style>
      <section className="experience" id="experience">
        <div className="experience-inner">
          <div className="section-label" style={{ fontFamily: "var(--font-mono)", fontSize: ".7rem", color: "var(--accent)", letterSpacing: ".2em", textTransform: "uppercase", marginBottom: "1rem", display: "flex", alignItems: "center", gap: ".8rem" }}>
            <span style={{ color: "var(--text3)" }}>//</span> Expérience
          </div>
          <h2 className="section-title" style={{ fontSize: "clamp(2rem,4vw,3rem)", fontWeight: 800, letterSpacing: "-.02em", lineHeight: 1.1 }}>
